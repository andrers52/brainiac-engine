...
import BEServer from '../be/server/singleton/BEServer.js'
import createButton from '../be/server/ui/Button.js'
import environment from '../be/server/agent/singleton/Environment.js'
import camera from '../be/server/agent/Camera.js'
...
function WidgetsServer() {
  ...
  this.onUserConnected = function (user, cameraSize) {
    ...
    //button with action
    let button = 
      createButton('blueParticle.jpg', null, () => console.log('button pressed!'))
  }
