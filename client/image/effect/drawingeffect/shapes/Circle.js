...
export default function Circle (context) {
  let lineWidth = 2
  let radius = (Math.min(context.canvas.width, context.canvas.height) / 2) - lineWidth //-lineWidth to avoid being cut at the sides
