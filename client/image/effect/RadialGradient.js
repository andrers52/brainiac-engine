...
export default function RadialGradient(context, parameters) {
  var radgrad =
  ...
  if(parameters.fillRect) {
    ...
    context.beginPath()
    context.arc(context.canvas.width/2,context.canvas.height/2,Math.min(context.canvas.width/2,context.canvas.height/2), 0, Math.PI*2)
    context.closePath()
