...
export default function ImageFilter  (imageName, applyOverOriginalImage, ...ImageFiltersArray) {

  let newImageName = applyOverOriginalImage? imageName : resourceStore.cloneImage(imageName)
  ...
  for (let i = 0; i < ImageFiltersArray.length; i = i + 2) {
    let arg = (i + 1 < ImageFiltersArray.length) ? ImageFiltersArray[i + 1] : null
