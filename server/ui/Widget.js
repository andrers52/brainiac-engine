...
function addVisibilityTestToCheckMove(camera) {
  ...
  this.checkMove = distance => {
    Assert.assert(distance instanceof Vector, 'BEClient.Widget#checkMove: distance is not a Vector')
...
export default function createWidget (imageName, inputRectangle) {
