...
export default function createToggleButton (
  ...
  let toggleButton = createButton((checked) ? selectedImageName : deselectedImageName, inputRectangle, null)

  let toggleButtonConfiguration =
                  {'defaultState': (checked) ? 'selected' : 'deselected',
                    'states':
                            [
                              {'stateName': 'selected', 'image': selectedImageName, 'audioName': (selectedAudio) ? selectedAudio : null},
                              {'stateName': 'deselected', 'image': deselectedImageName, 'audioName': (deselectedAudio) ? deselectedAudio : null}
                            ]
                  }
