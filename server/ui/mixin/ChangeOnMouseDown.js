...
export default function ChangeOnMouseDown (changeAction = 'shrink') {
  ...
  function executeChangeActionWhenMouseDown() {
    ...
    this.rectangle[changeAction](
      BECommonDefinitions.MOUSE_DOWN_CHANGE_FACTOR)
    isSelected = true
    return this
  }

  this.onMouseDownHit =
    EFunction.sequence(this.onMouseDownHit, executeChangeActionWhenMouseDown, this)
