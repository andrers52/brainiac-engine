...
export default function HasHint (text, font = 'GoodDog') {
  ...
  this.getHintText = function() {return this.hint.getText()}

  //kills hint when dying
  let self = this
  function hintDie() { self.hint.die() }
