...
export default function Pulsate (maxTimeinMilliseconds) {
  ...
  function pulsate() {
    if(grow)
      self.rectangle.grow(factor)
    else
      self.rectangle.shrink(factor)
  }
  ...
  this.startPulsate = function() {
    ...
    cycleIntervalId = setInterval(function() {grow = !grow}, cycleTime)
